...
public class German_login_6 {
    ...
    public void loginTest(String email, String password) {
        ...
        s.assertAll(); // Ensure all soft assertions are checked
    }

    @DataProvider(name = "testData")
    public Object[][] provideTestData() throws IOException {
        // Fetch test data from Excel
        String[] data = openBrowser.getTestData(6); // Fetch data from the 7th row (0-based index)
